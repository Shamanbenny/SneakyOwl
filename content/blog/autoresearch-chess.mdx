...
<div style={{ border: "1px solid rgba(148, 163, 184, 0.35)", borderRadius: "18px", padding: "1rem", margin: "1.5rem 0", background: "rgba(15, 23, 42, 0.04)" }}>
  <strong>Media slot: workflow diagram.</strong>
  <div style={{ marginTop: "0.45rem" }}>
    Planned visual: <code>seed engine</code> to <code>sandbox</code> to <code>Codex candidate</code> to <code>build/evaluate</code> to <code>approve/reject</code> to <code>ATTEMPTS.md</code>. The main contrast should be "agent writes code" versus "script owns the lab protocol."
  </div>
</div>
