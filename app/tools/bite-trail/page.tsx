...
export default function BiteTrailPage() {
  return (
    <div className="site-page-shell min-h-screen">
      <NavBar />
      <main
        className="mx-auto grid min-h-screen w-full content-center gap-6 pt-[100px]
          max-sm:pt-4 max-xl:px-[20px] xl:w-[1160px] xxl:w-[1480px]"
      >
        <BiteTrailSparklesTitle>
          <section className="grid gap-6 lg:items-stretch xl:grid-cols-[minmax(0,1.4fr)_minmax(360px,0.7fr)] xxl:grid-cols-[minmax(0,1.15fr)_minmax(360px,0.85fr)]">
            <div className="site-surface-card flex min-h-[200px] flex-col justify-between overflow-hidden rounded-[26px] border-[color:var(--site-accent-border-subtle)] p-6 shadow-[0_18px_45px_rgba(0,0,0,0.24),0_0_18px_rgba(16,185,129,0.035)] sm:p-6 xl:h-[220px] xxl:h-[224px]">
              <div>
