...
const ChessVersionInfo = () => {
  ...
  const chessVersions = [
    ...
    },
    {
      version: "1.1",
      keyFeatureTitle:
        "[DISCONTINUED] Minimax Algorithm with Alpha-Beta Pruning [Depth 3]",
      featuresImplemented: [
      ...
      avgDecisionTime: "??? seconds",
      estimatedTimeComplexity:
        "Ω(b^(d/2)), ϴ(b^(3d/4)), O(b^d), where b is the branching factor and d is the depth",
      noticeableWeakness: [
    ...
    },
    {
      version: "1.2",
      keyFeatureTitle:
        "Minimax Algorithm with Alpha-Beta Pruning and Move Ordering [Depth 3]",
      featuresImplemented: [
        "Uses depth-limited decision-making algorithm with alpha-beta pruning for faster decision-making",
        "Avoids exploring branches that won't affect the final decision",
